-- CREATE PROJECT IMAGES STORAGE
-- Run this SQL in your Supabase SQL Editor to create the project-images storage bucket and policies

-- Create the project-images bucket
INSERT INTO storage.buckets (id, name, public) 
VALUES ('project-images', 'project-images', true);

-- Create policies for the project-images bucket
